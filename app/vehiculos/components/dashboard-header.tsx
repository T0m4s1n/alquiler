...
import { Car, BarChart2, Plus, ArrowLeft } from "lucide-react"
...
export default function DashboardHeader({ showStats, toggleStats, openCreateModal }: DashboardHeaderProps) {
  return (
    <header className="bg-[#333] text-white py-6 px-8 shadow-lg">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          ...
          >
            <BarChart2 size={16} className="transition-transform duration-300 transform hover:scale-110" />
