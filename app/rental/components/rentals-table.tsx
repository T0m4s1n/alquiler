            ...
            <tr key={rental.id} className="hover:bg-gray-50 transition-colors duration-200">
              ...
              <td className="py-4 whitespace-nowrap">
                <div className="flex items-center group">
                  <User
                    size={16}
                    className="text-gray-400 mr-2 group-hover:text-[#333] transition-colors duration-200"
                  />
                  <span className="group-hover:font-medium transition-all duration-200 text-gray-800">{rental.nombreCliente}</span>
                </div>
              </td>
              <td className="py-4 whitespace-nowrap">
                <div className="flex items-center group">
                  <Car
                    ...
                    className="text-gray-400 mr-2 group-hover:text-[#333] transition-colors duration-200"
                  />
                  <span className="group-hover:font-medium transition-all duration-200 text-gray-800">{rental.detalleVehiculo}</span>
                </div>
              </td>
              <td className="py-4 whitespace-nowrap">
                <div className="flex items-center group">
              ...
              <td className="py-4 whitespace-nowrap">
                <div className="flex items-center group">
                  <DollarSign
                    size={16}
                    className="text-green-400 mr-1 group-hover:text-[#333] transition-colors duration-200 "
                  />
                  <span className="group-hover:font-medium transition-all duration-200 text-gray-800">
                    ${rental.costoTotal.toFixed(2)}
                  </span>
                </div>
              </td>
              <td className="py-4 whitespace-nowrap text-right">
                <div className="flex justify-end space-x-1">
                  <button
                    ...
                    title="Ver detalles"
                  >
                    <Info size={16} className="text-gray-600 hover:text-[#333] transition-colors duration-200" />
                  </button>
                  ...
                  {rental.estado === "PENDIENTE" && (
                    <>
                      <button
                        ...
                        className="p-2 bg-green-100 text-green-600 rounded-full hover:bg-green-200 transition-all duration-300 transform hover:scale-110 hover:rotate-3 hover:shadow-md"
